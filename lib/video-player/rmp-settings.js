export const rmpSettings = (src, subtitles, useAudioPlayer, state, vast_url, videoInfo) => {
	const settings = {
		...
		googleCast: true,
		errorOnlyShowCustomText: true, // dont show error code
		preload: "auto",
		allowLocalStorage: false,
		cuePoints: videoInfo?.chapters,

		contentMetadata: {
			poster: [
				state.containerbackgroundImage ? state.containerbackgroundImage : videoInfo?.thumbnail,
			],
		},
	};
